...
//   IP :
//   Port :
void nachricht_ausgeben(struct peer *current_peer, int internal, char *art, uint16_t id_absender, uint32_t ip_absender,
...
void read_header(char **key, char *transaktions_id, uint16_t *id_absender, uint32_t *ip_absender, uint16_t *port_absender,
            char **value,
